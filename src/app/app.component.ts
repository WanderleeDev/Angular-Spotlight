...
export class AppComponent implements OnInit {
  private readonly pageDescription = $localize`I invite you to explore my growth at Angular through these mini projects. Each project reflects my dedication and learning.`;
  private readonly pageTitle = $localize`Entry Page Angular`;
  ...
  private readonly keywords = $localize`my projects angular, css, tailwind, responsive design, typescript`;
